  ...
  <div class="ErrorPage">
    <div class="ErrorPage-container">
      <div class="ErrorPage-text">
        ...
        <p class="ErrorPage-subtitle">抱歉，您访问的页面不存在</p>
        <a class="Button Button--primary Button--blue ErrorPage-primaryButton" @click="router.push('/')"> 去往首页 </a>
        <div class="ErrorPage-otherButtonContainer">
          <span>或者</span>
          <button class="Button Button--plain Button--blue ErrorPage-otherButton ErrorPage-goBackButton" @click="router.go(-2)">
            返回上页
            <svg class="Zi Zi--ArrowRight" fill="currentColor" viewBox="0 0 24 24" width="24px" height="24px">
              <path
      ...
      <div class="ErrorPage-errorImageContainer">
        <img class="ErrorPage-errorImage" src="./picture/liukanshan_wire.png" alt="page error" />
      </div>
    </div>
  </div>
</template>
